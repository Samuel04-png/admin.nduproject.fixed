...
class _CostAnalysisScreenState extends State<CostAnalysisScreen>
  ...
  ScrollController get _scrollController {
    assert(_stepScrollControllers.isNotEmpty,
        '_stepScrollControllers should be initialised in initState');
  ...
  void initState() {
    ...
    _stepScrollControllers =
        List.generate(_stepDefinitions.length, (_) => ScrollController());
          ...
          () {
            if (title == 'Home') {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const ChangeManagementScreen()));
          ...
          child: Column(
            ...
            children: [
              const EditableContentText(
                  ...
                  fallback: 'Cost Benefit Analysis & Financial Metrics',
              ...
              EditableContentText(
                ...
                fallback:
                    'Bring each potential solution\'s investment profile, project value, ROI and NPV into one consolidated workspace.',
                category: 'business_case',
