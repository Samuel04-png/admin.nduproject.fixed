...
/// World-class, interactive app logo widget with theme-aware logo selection.
/// Automatically switches between Logo.png (light mode) and Ndu_logodarkmode.png (dark mode).
